...
const rejectedFormIds = ['sid-CCDD3E5F-BED0-43CD-8EED-EAA6C11F1E45', 'sid-E58541D9-F5E8-4190-9D3E-040B582A58F4', 'sid-0B61B920-F60A-4969-A292-AFE79168208F', 'sid-BED46E2A-3367-4D9F-B829-245A28B6158F'];
...
export class NgxDatatableService {
  ...
  getRejectCellClass({row, column, value}) {
    ...
    let result;
    if (row && row.taskDefinitionKey && rejectedFormIds.indexOf(row.taskDefinitionKey) > -1) {
