...
@Component({
  selector: 'igt-DictionaryModel',
  templateUrl: './DictionaryModel.component.html',
  styleUrls: ['./DictionaryModel.component.scss']
})
export class DictionaryModelComponent implements OnInit {
