...
//   * */
  ...
  save(e) {
    ...
    * */
    // 中标类型
    if (this.data.process == 'approved' && (this.data.isUsdOrRmb == '' || this.data.isUsdOrRmb == null)) {
      this.bidck.bidinfor.checkFormData('pricetype');
      ver = false;
    }
    // 中标日期
    if (this.isChan() && this.data.process == 'approved' && (this.data.bidWinningTime == '' || this.data.bidWinningTime == null)) {
      this.bidck.bidinfor.checkFormData('time');
      ver = false;
    }
    // 中标价格
    if (this.data.process == 'approved' && (this.data.biddingPrice == '' || this.data.biddingPrice == null)) {
    ...
    * */
    ...
    if (this.data.bidWinningTime == 'NaN-NaN-NaN') { this.data.bidWinningTime = null; }
