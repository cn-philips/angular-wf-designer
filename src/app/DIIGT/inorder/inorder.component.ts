...
import { decodeString, formatDatesNow,NumberThousandth,standardTime,isadopt} from '../../../assets/js/tools';
    ...
    return new Promise((resolve, reject) => {
      this.http.post(url).subscribe(res => {
        if (res.data) {
          ...
          this.dataBase.isPrebookApply=res.data.isPrebookApply!=null?res.data.isPrebookApply.toString():"0"; //是否关联prebook
