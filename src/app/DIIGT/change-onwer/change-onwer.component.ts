...
@Component({
  selector: 'app-change-onwer',
  templateUrl: './change-onwer.component.html',
  styleUrls: ['./change-onwer.component.scss']
})
export class ChangeOnwerComponent implements OnInit {
  ...
  public originalOwnerList = [
    { name: 'tiantao.zhang@philips.com', value: 'tiantao.zhang@philips.com' },
    { name: 'tiantao.zhang@philips.com', value: 'tiantao.zhang@philips.com' },
    { name: 'tiantao.zhang@philips.com', value: 'tiantao.zhang@philips.com' }
  ];
  public receiverList = [
  ...
  ngOnInit() {
    this.applicant = localStorage.getItem('ng_philips_code1');
  ...
  public confirm() {
    ...
    this.http.post(url, par).subscribe(res => {
      if (res && res.data == '0000') {
        ...
        this.router.navigate(['/changescene'], {
          queryParams: {
