...
import {decodeString, getType, formatDatesNow,standardTime,isadopt} from '../../../assets/js/tools';
...
export class InconmodifComponent implements OnInit {
  ...
  save(e) {
    ...
    // 获取mainId
    const mainId = decodeString(this.activatedRouter.queryParams['_value'].id);
    this.params.processInstanceTaskId = this.activatedRouter.queryParams['_value'].processInstanceTaskId;
