  ...
  getData() {
    ...
    this.http.get(url).subscribe(res => {
      if (res.data) {
        ...
        this.dataBase.approvalAfterSales = res.data.approvalAfterSales == 1 ? true : false;
        this.dataBase.nonStandardTerms = res.data.nonStandardTerms == 1 ? true : false;
        this.dataBase.logisticsTermsApproval = res.data.logisticsTermsApproval == 1 ? true : false;
        this.dataBase.approvalBidSecurity = res.data.approvalBidSecurity == 1 ? true : false;
        this.dataBase.paymentMethod = res.data.paymentMethod == 1 ? true : false;
        this.dataBase.technicalTerms = res.data.technicalTerms == 1 ? true : false;
        this.dataBase.provisionsInvolved = res.data.provisionsInvolved == 1 ? true : false;
