    ...
    return new Promise((resolve, reject) => {
      this.http.get(url2).subscribe((rest => {
        ...
        if (rest.data) {
          ...
          this.osData.applications=params.applications!=null&&params.applications!=""&&params.applications.length>0?params.applications:[{productName:"",localCtp:""}]
          this.osData.isPrebookApply=param.isPrebookApply!=null?param.isPrebookApply.toString():'0';
          ...
          this.osData.contractCancelReferenceId= param.contractCancelReferenceId;
