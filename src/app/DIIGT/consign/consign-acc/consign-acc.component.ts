...
@Component({
  selector: 'app-consign-acc',
  templateUrl: './consign-acc.component.html',
  styleUrls: ['./consign-acc.component.scss']
})
export class ConsignAccComponent implements OnInit {
  ...
  row = [{id:1,name:'进单准备表',taker:'喻昌云',end:'提交',ts:'提交进单准备表',time:'2021/11/1 14：22：46'},
    ...
    {id:1,name:'OA商务专员',taker:'xxx',end:'已批准',ts:'Order Summary',time:'N/A'},
