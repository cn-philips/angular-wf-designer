...
export class ProcessStatusPipe implements PipeTransform {
  processTypeMap = {
    ...
    'prebook_sales_apply':'修改Slot Reservation',
    'prebook_zpm_approval':'ZPM核查场地状态',
    'prebook_dsi_approval':'DSI审核',
    'prebook_oa_approval':'Slot Reservation-OA审核',
    'prebook_district_leader_approval':'District Leader审核',
    'prebook_sales_leader_approval':'Sales Leader审核',
    'prebook_oa_supplement':'OA补充信息',
    'prebook_om_backfill':'OM回填SO#',
    'prebook_end':'OM回填SO#结束',
    'prebook_dtj':'待提交',
    'PREBOOK':'Slot Reservation',
    'PREBOOKCANCELLED':'Slot Reservation-自动终止',
    'DEPSH2':'部门审核',
  };
