...
@Component({
  selector: 'page-winningbid-supplement',
  templateUrl: './winningbid-supplement.component.html',
  styleUrls: ['./winningbid-supplement.component.scss']
})
export class WinningbidSupplementComponent implements OnInit {
  //中标确认文件待补充
  ...
  public userList = [];
  public isHandle = 0;
  public type = 'winningbid'; // 补充文件类型-中标确认文件待补充
  ...
  getTableData() {
    this.formValues = {
      ...this.formValues,
      biddingConfirmSupplementFile: this.isHandle,
