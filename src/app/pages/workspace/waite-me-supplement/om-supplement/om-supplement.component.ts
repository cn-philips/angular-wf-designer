...
@Component({
  selector: 'page-om-supplement',
  templateUrl: './om-supplement.component.html',
  styleUrls: ['./om-supplement.component.scss']
})
export class OmSupplementComponent implements OnInit {
  //待OM上传SO#
