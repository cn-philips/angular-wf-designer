...
@Component({
  selector: 'page-oit-supplement',
  templateUrl: './oit-supplement.component.html',
  styleUrls: ['./oit-supplement.component.scss']
})
export class OitSupplementComponent implements OnInit {
  //OIT文件待补充
  ...
  public userList = [];
  public isHandle = 0;
  public type = 'oit'; // 补充文件类型-OIT文件待补充
  ...
  getTableData() {
    this.formValues = {
      ...this.formValues,
      oaSupplementFile: this.isHandle,
