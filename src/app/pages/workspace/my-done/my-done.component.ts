...
@Component({
  selector: 'cos-my-done',
  templateUrl: './my-done.component.html',
  styleUrls: ['./my-done.component.scss']
})
export class MyDoneComponent implements OnInit {
  ...
  getTableData() {
    ...
    this.http.post(`/act/ecos/apply/task/approved`, params).subscribe((rest => {
      if (rest.code === '0000') {
  ...
  exportData() {
    ...
    this.http.postDownload(`/act/ecos/report/export/approved`, params).subscribe(rest => {
