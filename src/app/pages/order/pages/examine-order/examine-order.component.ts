...
export class ExamineOrderComponent implements OnInit {
  ...
  getDataBase(): void {
    ...
    this.http.post(url).subscribe(res => {
      if (res.data) {
        ...
        this.dataBase.isPrebookApply = this.dataBase.isPrebookApply != null ? this.dataBase.isPrebookApply.toString() : "0";
        this.title = this.dataBase.detail.status == "DOAJDQR" ? "Order Confirm 进单确认" : "Review the Contract Summary 审核合同概要表";
