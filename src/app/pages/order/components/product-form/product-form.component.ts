...
import { getType, codeString } from '@core/util/tools';
...
export class PreOrderProductFormComponent implements OnInit {
  ...
  public isPrebookOk() {
    ...
    if (finds.length > 0) {
      ...
      if (!!!this.dataBases.preBook) {
        this.dataBases.preBook = {};
        this.dataBases.preBook.distributor = null;
      }
      Object.assign(this.dataBases.preBook, finds[0]);
      if (!!!this.dataBase.distributor){
        this.dataBase.distributor = null;
      }
  ...
  public ngOnInit(): void {
    ...
    this.validateForm = this.fb.group({
      ...
      switchValid: new FormControl({ value:true,disabled:false}),
