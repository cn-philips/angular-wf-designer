...
@Component({
  ...
  templateUrl: './win-check-table.component.html',
  styleUrls: ['./win-check-table.component.scss'],
...
export class WinCheckTableComponent implements OnInit {
  ...
  public gotoWin(item) {
    console.log(location.origin + environment.base_href + '/#/' + 'bidding/winning?id=' + codeString(item.mainId) + '&flag=1');
    window.open(location.origin + environment.base_href + '/#/' + 'bidding/winning?id=' + codeString(item.mainId) + '&flag=1');
  }
