...
@Component({
  selector: 'app-supplement-oa',
  templateUrl: './supplement-oa.component.html',
  styleUrls: ['./supplement-oa.component.scss']
})
export class SupplementOaComponent implements OnInit {
