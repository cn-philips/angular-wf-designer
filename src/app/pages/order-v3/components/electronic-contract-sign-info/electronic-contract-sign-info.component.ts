...
@Component({
  selector: "ecos-electronic-contract-sign-info",
  templateUrl: "./electronic-contract-sign-info.component.html",
  styleUrls: ["./electronic-contract-sign-info.component.scss"],
})
// interface SimpleChanges {
//   __index(propName: string): SimpleChange
// }
export class ElectronicContractSignInfoComponent implements OnInit {
  constructor(
