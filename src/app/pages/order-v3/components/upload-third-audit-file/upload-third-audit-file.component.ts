...
@Component({
  selector: "upload-third-audit-file",
  templateUrl: "./upload-third-audit-file.component.html",
  styleUrls: ["./upload-third-audit-file.component.scss"],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      multi: true,
      useExisting: forwardRef(() => UploadThirdAuditFileComponent),
    },
  ],
})
export class UploadThirdAuditFileComponent implements OnInit, ControlValueAccessor {
  @Input() limit = 5;
  ...
  uploadFile(data) {
    const uri = `/act/ecos/thirdParty/auditReport/upload/${this.applyId}`;    
